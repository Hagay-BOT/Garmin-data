...
# ── טכניקת ריצה — יעדים ──────────────────────────────────────────────────────
# ── ספי-מוכנות לשער אימוני-איכות (T5) ────────────────────────────────────────
# יום-איכות/לונג + מוכנות נמוכה → הצעה להחליף לקל/מנוחה (הסיפור של ה-3.5 שעות).
SLEEP_SCORE_MIN_FOR_QUALITY = 50     # ציון-שינה מתחת לזה = דגל
BODY_BATTERY_MIN_FOR_QUALITY = 30    # סוללת-גוף בבוקר מתחת לזה = דגל
