...
- "improve" = בדיוק 2 דגשים. **כל דגש = משפט אחד קצר עם שרשרת מלאה: מדד → פירוש קצר → פעולה עם עוגן שקל לזכור בריצה.**
  דוגמה טובה: "יחס אנכי 9.4% (מעט גבוה — קופץ למעלה) → קצר את הצעד וחשוב 'לגלוש קדימה, לא לקפוץ'."
  דוגמה רעה (אסור): "יחס אנכי גבוה, תשפר." (אין פירוש, אין עוגן).
