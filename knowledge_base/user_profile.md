...
2. **כוח עליון (A/B) אפשר לשלב בימי ריצה** — לא מפריע לרגליים.
3. מקם את C ביום ללא ריצה או ביום קל, באמצע השבוע, הרחק מהלונג.
4. דגש ברך/קרסול בכל אימון רגליים (סקוואט, hip thrust, calf raises, single-leg).
